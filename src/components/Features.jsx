        ...
        <div className='my-24 md:px-14 px-4 max-w-screen-2xl mx-auto' id='features'>
            <div className='flex flex-col lg:flex-row justify-between items-start gap-10'>
                <motion.div variants={fadeIn("right", 0.2)} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0.7 }} className='lg:w-1/4'>
                    ...
                    <p className='text-base text-tartiary'>A simple paragraph is comprised of major components. The first sentence, which is often a declarative sentence, is called the "topic sentence"</p>
                </motion.div>
                {/* featured cards */}
